...
use commands::{
    check_app_update, create_workspace, decide_approval, delete_frp_profile, delete_workspace,
    ...
    list_frp_profiles, list_pending_approvals, list_software, list_workspaces, open_url, open_workspace_directory,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            runtime::diagnostics::get_execution_policy_status,
            list_workspaces,
